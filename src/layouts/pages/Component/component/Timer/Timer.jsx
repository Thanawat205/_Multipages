...
function Timer() {
    ...
    <div className="timer-container">
        ...
        <p><input type="text" readOnly={true} value={secondsToString(seconds)} className='timer-display'/></p>
        <div className='timer-buttons'>
            <button className='btn btn-danger' onClick={resetClick}>Reset</button>
            <button className={'btn '+ (running ? 'btn-warning' : 'btn btn-success')} onClick={runClick}>{running ? 'Pause' : 'Run'}</button>
        </div>
    </div> );
}
